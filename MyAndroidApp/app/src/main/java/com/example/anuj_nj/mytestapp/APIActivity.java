...
public class APIActivity extends AppCompatActivity implements
    ...
    protected static final String TAG = "APIActivity";
...
//    private static final int MY_PERMISSION_REQUEST_CODE = 7171;
     ...
     * than this value.
     */
    public static final int FASTEST_UPDATE_INTERVAL_IN_MILLISECONDS =  3000;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rcObj.setLayoutManager(new LinearLayoutManager(APIActivity.this));
...
//            mLastUpdateTimeTextView.setText(String.format("%s: %s", mLastUpdateTimeLabel,mLastUpdateTime));
                Toast.makeText(this, "mLatitudeLabel :" + mCurrentLocation.getLatitude(), Toast.LENGTH_SHORT).show();
                Toast.makeText(this, "mLongitudeLabel :" + mCurrentLocation.getLongitude(), Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    if (null != listAddresses && listAddresses.size() > 0) {
                        ...
                        Toast.makeText(this, "_Location:" + _Location, Toast.LENGTH_LONG).show();
...
//         Call<PlaceDetails> objPlaceDetails = GooglePlaceAPI.getServiceData().getPlaceList();
//         Call<PlaceDetails> objPlaceDetails = GooglePlaceAPI.getServiceData().getByLocation(Double.toString(mLocation.getLatitude())+","+Double.toString(mLocation.getLongitude()));
        Call<PlaceDetails> objPlaceDetails = GooglePlaceAPI.getServiceData().getByTextSearchAndLocation("biryani+near+"+_Location,"");
        objPlaceDetails.enqueue(new Callback<PlaceDetails>() {
            ...
            public void onResponse(Call<PlaceDetails> call, Response<PlaceDetails> response){
                ...
                Log.i("dfsdfd","Response :" + objResultGoogle.get(0));
                ...
                rcObj.setAdapter(new RecycleViewAdapter(APIActivity.this,objResultGoogle));
                // Toast.makeText(APIActivity.this,"Success",Toast.LENGTH_LONG).show();
            }
            @Override
            public void onFailure(Call<PlaceDetails> call, Throwable t){
                Log.i("myApp", "error:"+t);
                Toast.makeText(APIActivity.this,"Error",Toast.LENGTH_LONG).show();
            }
        });
    }
...
//            Toast.makeText(APIActivity.this,"inside onstart",Toast.LENGTH_SHORT).show();
